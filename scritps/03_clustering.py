...
# Selecionar colunas numéricas relevantes (excluir identificadores e textos)
variaveis = [
...
df_cluster = df[variaveis].dropna()  # Remover linhas com valores faltantes
...
# ----------------------------------------
# Etapa 2 – Aplicar KMeans com número ideal de clusters (ex: 3)
# ----------------------------------------
k_ideal = 3  # Você pode ajustar isso após ver o gráfico
